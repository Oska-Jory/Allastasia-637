...
import org.oracle.entity.object.Directions;
import org.oracle.entity.object.GameObject;
import org.oracle.entity.object.Region;
...
public class Location {
    ...
    /**
     * @author Format <format@rune-server.org>
     * Checks if the player is within the given area or coordinates.
     */
    
    public boolean inArea(int swX, int swY, int nwX, int nwY) {
    	int x = getX();
    	int y = getY();
    	return x >= swX && y >= swY && x <= nwX && y <= nwY;
    }
