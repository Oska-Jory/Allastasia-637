package org.oracle.cache.format;

import org.oracle.cache.CacheContainer;
import org.oracle.cache.CacheManager;
import org.oracle.cache.stream.ByteInputStream;
import org.oracle.cache.stream.RSInputStream;
...
public class LandscapeParser {
    ...
    public static boolean parseLandscape(final int area, final int[] keys) {
    	...
    	if (area >= 12593 && area <= 12595 || area == 12849 || area == 12850 || area == 13107) {
    		return true;
    	}
